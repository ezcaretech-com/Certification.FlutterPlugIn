...
int getUCPIDRequestInfo (unsigned char *out, BOOL realName, BOOL gender, BOOL nationalInfo, BOOL birthDate, BOOL ci, unsigned char *nonce, int nonceLen, unsigned char *userAgreement, int userAgreementLen, unsigned char* url, int urlLen);
