...
- (int) cmsSignHashWithSigningTime:(int)idx password:(NSString*)password hashedSignSource:(NSData*)hashedSignSource signResult:(char*)signResult;
...
- (Certificate *) issueWithRefNumWithoutStore:(NSString*)refNum authCode:(NSString*)authCode password:(NSString*)password caName:(NSString*)caName testFlag:(NSUInteger)testFlag;
...
- (Certificate *) issueWithRefNumWithoutStore:(NSString*)refNum authCode:(NSString*)authCode ip:(NSString *)ip port:(int)port password:(NSString*)password caNum:(int)caNum isReIssue:(BOOL)isReIssue;
...
- (int) cmsSignWithSigningTime_T:(int)idx password:(NSString*)password randomKey:(NSData *)randomKey signSource:(NSData*)signSource signingTime:(NSData*)signingTime signResult:(char*)signResult;
...
- (int) cmsSignHash_S:(int)idx password:(ProtectedData*)password hashedSignSource:(NSData*)hashedSignSource dummy:(NSData*)dummy signResult:(char*)signResult;
...
- (int) cmsSignHashWithSigningTime_S:(int)idx password:(ProtectedData*)password hashedSignSource:(NSData*)hashedSignSource signResult:(char*)signResult;
- (int) cmsSignWithSigningTime_S:(int)idx password:(ProtectedData*)password signSource:(NSData*)signSource signingTime:(NSData*)signingTime signResult:(char*)signResult;
...
- (Certificate *) issueWithRefNumWithoutStore_S:(NSString*)refNum authCode:(NSString*)authCode ip:(NSString *)ip port:(int)port password:(ProtectedData*)password caNum:(int)caNum isReIssue:(BOOL)isReIssue;
- (Certificate *) issueWithRefNumWithoutStore_S:(NSString*)refNum authCode:(NSString*)authCode password:(ProtectedData*)password caName:(NSString*)caName testFlag:(NSUInteger)testFlag;
...
@interface CertManager(CloudData)

- (int) cmsSign_C:(NSData *)cert key:(NSData *)key pin:(ProtectedData *)pin signSource:(NSData*)signSource signingTime:(NSData*)signingTime signResult:(char*)signResult;
- (int) cmsSignFile_C:(NSData *)cert key:(NSData *)key pin:(ProtectedData*)pin fileInfo:(NSData*)fileInfo fileHash:(NSData*)fileHash signingTime:(NSData*)signingTime signResult:(char*)signResult;
- (int) cmsSignHash_C:(NSData *)cert key:(NSData *)key pin:(ProtectedData*)pin hashedSignSource:(NSData*)hashedSignSource dummy:(NSData*)dummy signResult:(char*)signResult;
- (int) simpleSign_C:(NSData *)cert key:(NSData *)key pin:(ProtectedData *)pin signSource:(NSData*)signSource signResult:(char*)signResult;
- (int) simpleSignHash_C:(NSData *)cert key:(NSData *)key pin:(ProtectedData *)pin hashedSignSource:(NSData*)hashedSignSource signResult:(char*)signResult;
- (int) koscomSign_C:(NSData *)cert key:(NSData *)key pin:(ProtectedData *)pin signSource:(NSData*)signSource signResult:(char*)signResult;
- (int) koscomSignHash_C:(NSData *)cert key:(NSData *)key pin:(ProtectedData *)pin hashedSignSource:(NSData*)hashedSignSource dummy:(NSData*)dummy signResult:(char*)signResult;
- (int) koscomSimpleSign_C:(NSData *)cert key:(NSData *)key pin:(ProtectedData *)pin signSource:(NSData*)signSource signResult:(char*)signResult;
